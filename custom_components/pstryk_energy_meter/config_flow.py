...
class PstrykEnergyMeterConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    def async_get_options_flow(config_entry):
        ...
        return PstrykEnergyMeterOptionsFlow()


class PstrykEnergyMeterOptionsFlow(config_entries.OptionsFlowWithReload):
    """Options flow for Pstryk Energy Meter with automatic reload"""
